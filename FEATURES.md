...
| Feature | Description |
|---------|-------------|
| Frontend display | Week-based view with current and upcoming menus; previous/next week navigation |
| Print view | Printer-friendly weekly menu layout rendered as an HTML table |
